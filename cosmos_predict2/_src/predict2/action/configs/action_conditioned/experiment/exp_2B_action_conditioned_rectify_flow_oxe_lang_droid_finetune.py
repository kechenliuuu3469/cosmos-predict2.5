"""
Stage 2: Fine-tune on DROID (DreamZero stacking) after OXE language pre-training.
...
DROID dataset uses empty text (ai_caption="") and real numerical actions,
...
ac_reason_embeddings_rectified_flow_2b_256_320_oxe_lang_droid_finetune = LazyDict(
    dict(
        defaults=[
        ...
        job=dict(
            ...
            name="2b_oxe_lang_droid_finetune",
        ),
        optimizer=dict(
            lr=32e-5,
            weight_decay=0.1,
...
for _item in [ac_reason_embeddings_rectified_flow_2b_256_320_oxe_lang_droid_finetune]:
