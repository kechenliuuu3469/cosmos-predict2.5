"""
Stage 2: Fine-tune on Bridge after OXE EE pre-training.
...
ac_reason_embeddings_rectified_flow_2b_256_320_oxe_ee_bridge_finetune = LazyDict(
    dict(
        defaults=[
        ...
        job=dict(
            ...
            name="2b_oxe_ee_bridge_finetune",
        ),
        optimizer=dict(
            lr=32e-5,
            weight_decay=0.1,
...
for _item in [ac_reason_embeddings_rectified_flow_2b_256_320_oxe_ee_bridge_finetune]:
