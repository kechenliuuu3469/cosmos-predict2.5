...
ac_reason_embeddings_rectified_flow_2b_256_320_droid_dreamzero = LazyDict(
    dict(
        defaults=[
        ...
        job=dict(
            ...
            name="new_droid_baseline2_dreamzero",
        ),
        optimizer=dict(
            lr=32e-5,
            weight_decay=0.1,
...
for _item in [ac_reason_embeddings_rectified_flow_2b_256_320_droid_dreamzero]:
